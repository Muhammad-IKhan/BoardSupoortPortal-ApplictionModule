...
<a href="{{ route('firstFormView') }}" class="@if(request()->routeIs('firstFormView')) text-gray-900 border-b-2 border-indigo-500 @else text-gray-500 hover:text-gray-900 hover:border-gray-300 @endif inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium">
    Oline Receipt / Application
</a>
<a href="javascript:void(0)" 
   id="toggleNav" 
   class=" border-indigo-500  text-gray-500 hover:text-gray-900 hover:border-gray-300  inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium"
   onclick="toggleNav()">
    Latest
</a>
<a href="{{ route('dashboard') }}" class="@if(request()->routeIs('dashboard')) text-gray-900 border-b-2 border-indigo-500 @else text-gray-500 hover:text-gray-900 hover:border-gray-300 @endif inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium">
    Dashboard
</a>
